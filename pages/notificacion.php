...
<body>
    ...
    <div class="notificacion">
        ...
        <section>
            ...
            <nav class="peopleNotificacion"></nav>
        </section>
    </div>
    <script>
        for (let i = 1; i <= 30; i++) {
            document.querySelector(".peopleNotificacion").innerHTML+=`
                <div>
                    <h3>${i}</h3>
                    <label>Brian Michel Hernandez Garcia</label>
                    <div>
                        <a href="#">
        ...
        document.querySelector(".peopleNotificacion").addEventListener("click", e =>{
